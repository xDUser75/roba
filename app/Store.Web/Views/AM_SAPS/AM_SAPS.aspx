...
<asp:Content ID="indexContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
 ...
 <h3>Загрузка структуры организации, личных и биометрических данных сотрудников</h3>
    <table> 
        <tr>
            <td>Выберите цех&nbsp;</td>
            <td>
        ...
        <tr>
            ...
            <td colspan=2>
               <font color="red"><i>Выберите цех и нажмите на кнопку "Запросить данные"</i></font>
                <br/><b>Загрузка структуры и персональных данных может занять несколько минут</b>
            </td>
        </tr>    
    </table>
