...
(function($) {
	...
	$.alerts = {
        ...
        prompt: function (message, value, title, callback, okText, cancelText) {
		...
		_show: function(title, msg, value, type, callback, okText, cancelText) {
		    if (!okText) okText = $.alerts.okButton;
		    if (!cancelText) cancelText = $.alerts.cancelButton;
			$.alerts._hide();
    ...
    jPrompt = function (message, value, title, callback, okText, cancelText) {
        $.alerts.prompt(message, value, title, callback, okText, cancelText);
	};
