namespace Store.Web.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddApplicationServicesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("Store.ApplicationServices")
                    .Pick()
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("Store.Data")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("Store.Core"));
        }
